      ...
      <div className="flex_container">
        <div className="flexitem">
          ...
          <div style={{ textAlign: "center" }}>
            <span style={{ fontSize: "1.5vw" }}>Top Offers</span>
          </div>
        </div>
        <div className="flexitem">
          <img
          ...
          ></img>
          <div style={{ textAlign: "center" }}>
            <span style={{ fontSize: "1.5vw" }}>Grocery</span>
          </div>
        </div>
        <div className="flexitem">
          <img
          ...
          ></img>
          <div style={{ textAlign: "center" }}>
            <span style={{ fontSize: "1.5vw" }}>Mobiles</span>
          </div>
        </div>
        <div className="flexitem">
          <img
        ...
        <div className="flexitem">
          ...
          ></img>
          <div style={{ textAlign: "center" }}>
            <span style={{ fontSize: "1.5vw" }}>Travel</span>
          </div>
        </div>
        <div className="flexitem">
          <img
